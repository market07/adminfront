<form id="frmScm" name="frmScm" action="scm_ps.php" method="post" enctype="multipart/form-data">
    ...
    <table class="table table-cols">
        ...
        <tr>
            ...
            <td colspan="form-inline"><?= $getData['scmCode']; ?></td>
            <th>
                수수료정보
            </th>
            <td colspan="form-inline">
                <?php
                if( $getData['supplierType']=='A'){
                    echo "카테고리 조정";
                }
                elseif($getData['supplierType'] =='B'){
                    echo "카테고리 수수료";
                }
                else{
                    echo "고정 수수료";
        ...
        <tr>
            ...
            <td colspan="form-inline"><?= $getData['scmPermissionInsert']; ?></td>
            <?php 
                if($getData['supplierType'] =='A'){
                    echo "<th>조정수수료</th>" ;
                    echo "<td colspan='form-inline'>";
                    echo $getData['scmProCom'].'%';
                    echo "</td>";
                }
            ?>
        </tr>
