    ...
    <table class="table table-rows">
        ...
        if (gd_isset($data)) {
            ...
            foreach ($data as $key => $val) {
				...
				//lkm 메모
				//gd_debug($val['applyFl']);
                if($val['applyFl'] !='y') { //승인요청이아니면
                ...
                <tr>
                    ...
                    <td class="center">
                        <div><span class="font-num"><?=gd_currency_display($val['goodsUnitPrice1']); ?></span></div>
                    </td>
                    ...
                    <td class="center padlr10"><a href="./goods_register.php?goodsNo=<?=$val['goodsNo']; ?>" class="btn btn-white btn-sm">수정</a></td>
                </tr>
                <?php
            }
        } else {
