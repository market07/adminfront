		...
		<div id="depth-toggle-layer-<?=$toggleId?>Info">
			...
			<table class="table table-cols">
				...
				<tr>
					<th>Percentage</th>
					<td>
						<label class="radio-inline"><input type="text" name="catPercentage" value="<?=gd_isset($data['catPercentage']);?>"  /></label>
					</td>
				</tr>
				<tr>
					<th>NaverId</th>
					<td>
						<label class="radio-inline"><input type="text" name="catNaverid" value="<?=gd_isset($data['catNaverid']);?>"  /></label>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<th>PC쇼핑몰<br/>여분메뉴 노출상태</th>
					<td colspan="3">
						<label class="radio-inline"><input type="radio" name="cateEtcDisplayFl" value="y" <?=gd_isset($checked['cateEtcDisplayFl']['y']);?> />노출함</label>
						<label class="radio-inline"><input type="radio" name="cateEtcDisplayFl" value="n" <?=gd_isset($checked['cateEtcDisplayFl']['n']);?> />노출안함</label>
					</td>
				</tr>
				<!--
				<tr>
					<th>모바일쇼핑몰<br/>여분메뉴 노출상태</th>
					<td colspan="3">
						<label class="radio-inline"><input type="radio" name="cateEtcDisplayMobileFl" value="y" <?=gd_isset($checked['cateEtcDisplayMobileFl']['y']);?> />노출함</label>
						<label class="radio-inline"><input type="radio" name="cateEtcDisplayMobileFl" value="n" <?=gd_isset($checked['cateEtcDisplayMobileFl']['n']);?> />노출안함</label>
					</td>
				</tr>
				-->
				<?php }?>
