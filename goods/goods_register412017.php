...
<script type="text/javascript">
    ...
    function option_grid(manualFl) {
        ...
        for (var j = 0; j <= optTotCnt; j++) {
            if (j == 0) {
                ...
                addHtml += '<th class="width10p">GoodsUnitprice</th>';
                ...
                /*addHtml += '<th class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice1" class="form-control width-xs" /></div></th>';
                addHtml += '<th class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice2" class="form-control width-xs" /></div></th>';
                addHtml += '<th class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice3" class="form-control width-xs" /></div></th>';
                addHtml += '<th class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice4" class="form-control width-xs" /></div></th>';
                addHtml += '<th class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice5" class="form-control width-xs" /></div></th>';
                addHtml += '<th class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice6" class="form-control width-xs" /></div></th>';
                addHtml += '<th class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice7" class="form-control width-xs" /></div></th>';
                addHtml += '<th class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice8" class="form-control width-xs" /></div></th>';
                addHtml += '<th class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice9" class="form-control width-xs" /></div></th>';
                addHtml += '<th class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice10" class="form-control width-xs" /></div></th>';*/
                addHtml += '</tr>';
            } else {
				...
				/*addHtml += '<td class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice1_' + optKey2 + '" name="optionY[optionGoodsUnitprice1][]" value="" class="form-control width-xs" /></div></td>';
				addHtml += '<td class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice2_' + optKey2 + '" name="optionY[optionGoodsUnitprice2][]" value="" class="form-control width-xs" /></div></td>';
				addHtml += '<td class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice3_' + optKey2 + '" name="optionY[optionGoodsUnitprice3][]" value="" class="form-control width-xs" /></div></td>';
				addHtml += '<td class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice4_' + optKey2 + '" name="optionY[optionGoodsUnitprice4][]" value="" class="form-control width-xs" /></div></td>';
				addHtml += '<td class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice5_' + optKey2 + '" name="optionY[optionGoodsUnitprice5][]" value="" class="form-control width-xs" /></div></td>';
				addHtml += '<td class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice6_' + optKey2 + '" name="optionY[optionGoodsUnitprice6][]" value="" class="form-control width-xs" /></div></td>';
				addHtml += '<td class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice7_' + optKey2 + '" name="optionY[optionGoodsUnitprice7][]" value="" class="form-control width-xs" /></div></td>';
				addHtml += '<td class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice8_' + optKey2 + '" name="optionY[optionGoodsUnitprice8][]" value="" class="form-control width-xs" /></div></td>';
				addHtml += '<td class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice9_' + optKey2 + '" name="optionY[optionGoodsUnitprice9][]" value="" class="form-control width-xs" /></div></td>';
				addHtml += '<td class="center"><div class="form-inline"><input type="text" id="option_optionGoodsUnitprice10_' + optKey2 + '" name="optionY[optionGoodsUnitprice10][]" value="" class="form-control width-xs" /></div></td>';
                addHtml += '</tr>';*/
            }
        }
    ...
    function add_item_price()
    {
        ...
        // var c = $('#unitPrice').attr('class');
        // var x = '<tr><th>Unit Price of 1 Item</th>
        //         <td><input type ="text" name="unitPrice11" value="" class="form-control width-2xl js-maxlength" maxlength="250"/>       
        //         <td></tr>';
        // $('#unitPrice').parent().append(x);
        ...
        <table class="table table-cols">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="option"></div>
                    <div id="optionGrid" style="width: 900px;overflow-x: scroll;">
                        <?php
                        if (!empty($data['option']) && $data['optionCnt'] > 0) {
                            ...
                            <table id="optionGridTable" class="table table-cols">
                                ...
                                <tr>
									...
									<th class="width10p">GoodsUnitprice</th>
									<!--<th class="width10p">GoodsUnitprice2</th>
									<th class="width10p">GoodsUnitprice3</th>
									<th class="width10p">GoodsUnitprice4</th>
									<th class="width10p">GoodsUnitprice5</th>
									<th class="width10p">GoodsUnitprice6</th>
									<th class="width10p">GoodsUnitprice7</th>
									<th class="width10p">GoodsUnitprice8</th>
									<th class="width10p">GoodsUnitprice9</th>
									<th class="width10p">GoodsUnitprice10</th>-->
                                ...
                                <tr>
									...
									<!--<th class="center">
                                        <div class="form-inline">
                                            <input type="text" id="option_optionGoodsUnitprice2" class="form-control width-xs"/>
                                        </div>
                                    </th>
									<th class="center">
                                        <div class="form-inline">
                                            <input type="text" id="option_optionGoodsUnitprice3" class="form-control width-xs"/>
                                        </div>
                                    </th>
									<th class="center">
                                        <div class="form-inline">
                                            <input type="text" id="option_optionGoodsUnitprice4" class="form-control width-xs"/>
                                        </div>
                                    </th>
									<th class="center">
                                        <div class="form-inline">
                                            <input type="text" id="option_optionGoodsUnitprice5" class="form-control width-xs"/>
                                        </div>
                                    </th>
									<th class="center">
                                        <div class="form-inline">
                                            <input type="text" id="option_optionGoodsUnitprice6" class="form-control width-xs"/>
                                        </div>
                                    </th>
									<th class="center">
                                        <div class="form-inline">
                                            <input type="text" id="option_optionGoodsUnitprice7" class="form-control width-xs"/>
                                        </div>
                                    </th>
									<th class="center">
                                        <div class="form-inline">
                                            <input type="text" id="option_optionGoodsUnitprice8" class="form-control width-xs"/>
                                        </div>
                                    </th>
									<th class="center">
                                        <div class="form-inline">
                                            <input type="text" id="option_optionGoodsUnitprice9" class="form-control width-xs"/>
                                        </div>
                                    </th>
									<th class="center">
                                        <div class="form-inline">
                                            <input type="text" id="option_optionGoodsUnitprice10" class="form-control width-xs"/>
                                        </div>
                                    </th>-->
                                    <th class="center">
                                        <div class="form-inline"><?=gd_currency_symbol(); ?>
                                ...
                                foreach ($data['option'] as $key => $val) {
                                    ...
                                    <tr id="tbl_option_info_<?=$key+1?>">
										...
										<!--<td class="center">
                                            <div class="form-inline">
                                                <input type="text" name="optionY[optionGoodsUnitprice2][]" value="<?=gd_isset($data['option'][$key]['optionGoodsUnitprice2']); ?>" class="form-control width-xs"/>
                                            </div>
                                        </td>
										<td class="center">
                                            <div class="form-inline">
                                                <input type="text" name="optionY[optionGoodsUnitprice3][]" value="<?=gd_isset($data['option'][$key]['optionGoodsUnitprice3']); ?>" class="form-control width-xs"/>
                                            </div>
                                        </td>
										<td class="center">
                                            <div class="form-inline">
                                                <input type="text" name="optionY[optionGoodsUnitprice4][]" value="<?=gd_isset($data['option'][$key]['optionGoodsUnitprice4']); ?>" class="form-control width-xs"/>
                                            </div>
                                        </td>
										<td class="center">
                                            <div class="form-inline">
                                                <input type="text" name="optionY[optionGoodsUnitprice5][]" value="<?=gd_isset($data['option'][$key]['optionGoodsUnitprice5']); ?>" class="form-control width-xs"/>
                                            </div>
                                        </td>
										<td class="center">
                                            <div class="form-inline">
                                                <input type="text" name="optionY[optionGoodsUnitprice6][]" value="<?=gd_isset($data['option'][$key]['optionGoodsUnitprice6']); ?>" class="form-control width-xs"/>
                                            </div>
                                        </td>
										<td class="center">
                                            <div class="form-inline">
                                                <input type="text" name="optionY[optionGoodsUnitprice7][]" value="<?=gd_isset($data['option'][$key]['optionGoodsUnitprice7']); ?>" class="form-control width-xs"/>
                                            </div>
                                        </td>
										<td class="center">
                                            <div class="form-inline">
                                                <input type="text" name="optionY[optionGoodsUnitprice8][]" value="<?=gd_isset($data['option'][$key]['optionGoodsUnitprice8']); ?>" class="form-control width-xs"/>
                                            </div>
                                        </td>
										<td class="center">
                                            <div class="form-inline">
                                                <input type="text" name="optionY[optionGoodsUnitprice9][]" value="<?=gd_isset($data['option'][$key]['optionGoodsUnitprice9']); ?>" class="form-control width-xs"/>
                                            </div>
                                        </td>
										<td class="center">
                                            <div class="form-inline">
                                                <input type="text" name="optionY[optionGoodsUnitprice10][]" value="<?=gd_isset($data['option'][$key]['optionGoodsUnitprice10']); ?>" class="form-control width-xs"/>
                                            </div>
                                        </td>-->
                                        <td class="center">
                                            <div class="form-inline">
