    ...
    <table class="table table-cols">
        ...
        if ($orderData['mode'] == 'register') {
            ...
            <tr>
                ...
                <td colspan="3">
                    <label>
                        <input type="radio" name="statusFl" value="r" <?php echo gd_isset($checked['statusFl']['r']); ?> onclick="$('#godobillSend').hide();"/>미발행
                    </label>
                    <label>
                    ...
                    <?php if (isset($orderData['statusFl']) != 'r') { ?>
                        <label>
                            <input type="radio" name="statusFl" value="c" <?php echo gd_isset($checked['statusFl']['c']); ?> onclick="$('#godobillSend').hide();"/>발행취소
                        </label>
                    <?php } ?>
                </td>
            </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="taxCompany" value="<?php echo gd_isset($orderData['taxCompany']); ?>" class="form-control"/>
            </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#frmTaxInvoice').formProcess('warn', [
            {
            ...
            , {'inputName': 'requestGoodsNm', 'name': '상품명', 'required': true}
            , {'inputName': 'taxBusiNo[]', 'name': '사업자번호', 'required': true, 'number': 'number'}
            , {'inputName': 'taxCompany', 'name': '회사명', 'required': true}
            , {'inputName': 'taxCeoNm', 'name': '대표자명', 'required': true}
            , {'inputName': 'taxService', 'name': '업태', 'required': true}
            , {'inputName': 'taxItem', 'name': '종목', 'required': true}
        ...
        <?php
          if (isset($orderData['statusFl']) == 'y') {
            echo '$(\'#godobillSend\').show();';
          } else {
            echo '$(\'#godobillSend\').hide();';
          }
        ?>
    });
