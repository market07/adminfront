            ...
            <div class="col-xs-6">
                ...
                <div>
                    <table class="table table-cols table-toggle">
                        ...
                        <tr>
                            <th>
                                <button type="button" class="btn btn-sm btn-link js-pay-toggle" data-number="<?= ($data['totalGoodsDcPrice'] + $data['totalMemberDcPrice'] + $data['totalMemberOverlapDcPrice'] + $data['totalCouponOrderDcPrice'] + $data['totalCouponGoodsDcPrice'] + $data['totalCouponDeliveryDcPrice'])?>" data-target="toggleDcPrice">보기</button>
                                총 할인금액
                            </th>
                            <th class="th">
                                ...
                                <div class="text-danger">
                                    (-) <?= gd_currency_display($data['totalGoodsDcPrice'] + $data['totalMemberDcPrice'] + $data['totalMemberOverlapDcPrice'] + $data['totalCouponOrderDcPrice'] + $data['totalCouponGoodsDcPrice'] + $data['totalCouponDeliveryDcPrice']); ?>
                                    <?php
