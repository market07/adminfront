    ...
    <table class="table table-rows">
        ...
        <tr class="nowrap">
            ...
            if (!$isProvider) { ?>
                ...
                <th rowspan="2" class="width5p">회원할인</th>
                        ...
                        <tr id="statusCheck_<?= $statusMode; ?>_<?= $val['sno']; ?>" class="text-center">
                            ...
                            <td class="text-right">
                                <?php if ($isUseMall == true) { ?>
                                    <?= gd_global_order_currency_display(($val['goodsUnitPrice'] + $val['optionPrice'] + $val['optionTextPrice']) * $val['goodsCnt'], $data['exchangeRate'], $data['currencyPolicy']); ?>
                                <?php } else { ?>
                                    <?= gd_currency_display(($val['goodsUnitPrice'] + $val['optionPrice'] + $val['optionTextPrice']) * $val['goodsCnt']); ?>
                                <?php } ?>
                            </td>
                             <td class="text-right">
                                <?php if ($isUseMall == true) { ?>
                            ...
                            <?php if (!$isProvider) { ?>
                                ...
                                <?php if (($rowDelivery == 0 && $data['mallSno'] == DEFAULT_MALL_NUMBER) || ($rowAll == 0 && $data['mallSno'] > DEFAULT_MALL_NUMBER)) { ?>
                                    <td <?=$orderDeliveryRowSpan?> class="text-right">
                                        <?php if ($isUseMall == true) { ?>
                                            <?= gd_global_order_currency_display($val['divisionDeliveryCharge'], $data['exchangeRate'], $data['currencyPolicy']); ?>
                                        <?php } else { ?>
                                        <?= gd_currency_display($val['divisionDeliveryCharge']); ?>
                                        <?php } ?>
                                    </td>
                                <?php } ?>
