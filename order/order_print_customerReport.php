...
<div class="page-break">
    ...
    <table class="table table-rows">
        ...
        <tr>
            ...
            <th class="width5p"><?php if ($data['mallSno'] != '2') echo __('회원할인'); else echo __('회원') . '<br/>' . __('할인');?></th>
        ...
        <tr>
            <td colspan="11" class="text-right">
                ...
                <?=gd_global_order_currency_display($data['totalDeliveryCharge'], $data['exchangeRate'], $data['currencyPolicy'])?><?= '(' . __('배송비') .')'; ?> - <?=gd_global_order_currency_display($data['totalSalePrice'] + $data['useMileage'] + $data['useDeposit'], $data['exchangeRate'], $data['currencyPolicy'])?>(<?= __('할인'); ?>) =
            ...
            <table class="table table-cols">
                ...
                <tr>
                    ...
                    <td class="input_area right text-danger">
                        <span class="font-num">
                            (-) <?php echo gd_currency_display($data['totalSalePrice'] + $data['useMileage'] + $data['useDeposit']); ?>
                            <?php if (empty($data['isDefaultMall']) === true) { ?>
                                (<?= gd_global_order_currency_display(($data['totalSalePrice'] + $data['useMileage'] + $data['useDeposit']), $data['exchangeRate'], $data['currencyPolicy']); ?>)
                            <?php } ?>
                        </span>
                    </td>
                </tr>
