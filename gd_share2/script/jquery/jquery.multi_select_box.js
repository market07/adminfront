					...
					for (var j = 0; j < data.length; j++)
					{
						...
						// $('<option/>', {
							...
							// data: {
								...
								// percentage: data[j]['catPercentage'],
								// naverid: data[j]['catNaverid'],
							// }
						// }).appendTo(targetID);
						
						
						$('<option value="' + data[j]['optionValue'] + '" data-percentage="' + data[j]['catPercentage'] + '" data-naverid="' + data[j]['catNaverid'] + '">' + data[j]['optionText'] + '</option>').appendTo(targetID);
