<?php
$pathChunk = parse_url($_GET['code']);
$pathArray = explode('/', $pathChunk['path']);
if (isset($pathChunk['query'])) {
...
if ($path == 'board') {
    if (isset($bdId)) {
        $uploadCode = "/data/editor/" . $path . "/" . $bdId . "/";
    }
} else {
    $uploadCode = "/data/editor/" . $path . "/";
}
...
<div id="pop_wrap">
    ...
    <div id="pop_container2" class="pop_container2">
        <!-- content -->
        <form id="editor_upimage" name="editor_upimage" action="./file_uploader.php" method="post"
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
        <!-- content -->
        <div id="pop_content">
            <p class="dsc"><em id="imageCountTxt">0장</em>/10장 <span class="bar">|</span> <em id="totalSizeTxt">0MB</em>/50MB
            </p>
    ...
    <div id="pop_footer">
        <div class="btn_area">
            <a href="#"><img src="../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인"
                             id="btn_confirm"></a>
            <a href="#"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소"
                             id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
