        ...
        <?php if (gd_is_provider() === false) { ?>
            <div class="main-section">
                ...
                <ol class="board-list-newest content list-unstyled reform">
                    <li>
                        <a href="http://plus.godo.co.kr/goods/view.gd?idx=24" target="_blank">상품/주문 : 플러스리뷰 <img src="<?= PATH_ADMIN_GD_SHARE; ?>img/icon_new.png" alert="NEW" class="img-fix"/></a>
                    </li>
                    <li>
                        <a href="http://plus.godo.co.kr/goods/view.gd?idx=23" target="_blank">상품/주문 : 매입처 관리 <img src="<?= PATH_ADMIN_GD_SHARE; ?>img/icon_new.png" alert="NEW" class="img-fix"/></a>
                    </li>
                    <li>
                        <a href="http://plus.godo.co.kr/goods/view.gd?idx=20" target="_blank">상품/주문 : 검색창 상품추천</a>
                    </li>
                    <li>
                        <a href="http://plus.godo.co.kr/goods/view.gd?idx=18" target="_blank">마케팅 : 인스고위젯</a>
                    </li>
                </ol>
