        ...
        <div class="slide-items-wrap">
            <div class="single-item">
                ...
                <div class="slide-item">
                    <img src="<?= PATH_ADMIN_GD_SHARE ?>img/icon_new.png">
                    <span class="slide-item-text">
                        <a href="/service/service_info.php?menu=convenience_livefeed_info">실시간으로 응답하라! 1:1 상담채팅</a>
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="main-section">
        ...
        <div class="marketingservice-table">
            <table class="table table-bordered mgb0">
                ...
                <tr>
                    <td class="icon-arr-r <?php if ($svcStates['naver'] === true) {
                        echo 'active';
                    } ?>">
                        <a href="<?php echo URI_ADMIN; ?>marketing/naver_config.php">네이버 쇼핑</a>
                    </td>
                    <td class="icon-arr-r <?php if ($svcStates['daum'] === true) {
                        echo 'active';
                    } ?>">
                        <a href="<?php echo URI_ADMIN; ?>marketing/daumcpc_config.php">다음 쇼핑하우</a>
                    </td>
                </tr>
                <tr>
                    <td class="icon-arr-r">
                        <a href="<?php echo URI_ADMIN; ?>marketing/marketing_info.php?menu=viral_info">바이럴마케팅</a>
                    </td>
                    <td class="icon-arr-r">
                        <a href="<?php echo URI_ADMIN; ?>marketing/marketing_info.php?menu=keyword_info">통합 키워드광고</a>
                    </td>
                </tr>
            </table>
        </div>
